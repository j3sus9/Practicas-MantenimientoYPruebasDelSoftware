...
public class ClubDeportivo {
	...
	public void anyadirActividad(Grupo g) throws ClubException {
		...
		if (pos == -1) { // El grupo es nuevo
			if (ngrupos >= grupos.length) { //ERROR 3: Aunque saltaría la excepción al hacer grupos[ngrupos] despues, es mejor controlar la excepción
