...
public class RonQI2Silver extends RonQI2{
    ...
    */
    public void obtenerNuevaLectura(){
        ...
        lecturasS.add(disp.leerSensorSonido()); //Es leerSensorSonido(), no leerSensorPresion()
    ...
    */
    ...
    public boolean evaluarApneaSuenyo() {
        ...
        if (avgP > thresholdP && avgS > thresholdS){ //La primera comparación es >, no >=
            resultado = true; //Aquí se tiene que devolver true
        }   
        else{
            resultado = false; //Aquí se tiene que devolver false
        }
        return resultado;
    }
